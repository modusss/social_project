...
class NeedsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create need" do
    assert_difference("Need.count") do
      post needs_url, params: { need: { attended: @need.attended, beneficiary: @need.beneficiary, family_id: @need.family_id, name: @need.name } }
    end
  ...
  test "should update need" do
    patch need_url(@need), params: { need: { attended: @need.attended, beneficiary: @need.beneficiary, family_id: @need.family_id, name: @need.name } }
