  ...
  private
    ...
    def family_params
      params.require(:family).permit(
        ...
        :food_basket_status,
        members_attributes: [:id, :name, :age, :role, :custom_role, :birth_date, :age_registered_at, :firm_in_faith, 
    ...
    def member_params
      params.require(:member).permit(:name, :age, :role, :custom_role, :birth_date, :age_registered_at, :firm_in_faith)
    end
